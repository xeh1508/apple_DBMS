...
ui <- dashboardPage(
  ...
  dashboardBody(
    ...
    uiOutput("user_table"),
    # tags$footer(tags$i("©2020 NYU Shanghai Library. Developer: Yujie Xiang, Data Services Fellow."),
    #             align = "center", style = "
    #           position:fixed;
    #           bottom:0;
    #           right:0;
...
server <- function(input, output, session) {
  ...
  output$tab6UI <- renderUI({
    ...
    box(title = 'About this app',width = NULL, status = "primary",solidHeader = TRUE,
      ...
      tags$head(tags$style(HTML("a {color: blue}"))),
      tags$a(img(src = 'github.png', height = 20),
             href="https://github.com/xeh1508/apple_DBMS",),
      br(),
      br(),
      h5(strong("Apple Sales Database")),
      ...
      br(),
      h5(strong("Developer")),
      img(src = 'grad.png', height = 150, align = "right"),
      
      "Yujie Xiang, '20SPS, Applied Analytics, Columbia University.",
      tags$a(img(src = 'linkedin.png', height = 20),
             href="http://www.linkedin.com/in/yujie-xiang"),
      br(),
  ...
  #   # box(title = 'About this app',width = NULL, status = "primary",solidHeader = TRUE,
  #       p("As an extension to PineApple Sales Dashboard, this Shiny app is a prototype of a database management system, featuring a variety of functions. 
  #         PineApple Sales Dashboard, a business intelligence dashboard, focuses on the front-end user interaction; this app addresses the needs in back-end database management."),
  #       "If you want to find out how we created the Business Intelligence dashboard, please visit",
  #       tags$head(tags$style(HTML("a {color: blue}"))),
  #       tags$a(href="https://yundai.shinyapps.io/2020-business-intelligence/", 
  #              "here."),
  #       " If you are interested in how we created this database management platform, please visit ",
  #       tags$head(tags$style(HTML("a {color: blue}"))),
  #       tags$a(href="http://shanghai.hosting.nyu.edu/data/r/case-3-sql-shiny.html", 
  #              "here."), 
  #       br(),
  #       br(),
  #       h4(strong("Developer")),
  #       p("Yujie Xiang, Data Services Fellow, NYU Shanghai Library"),
  #       br(),
  #       h4(strong("PineApple Sales Database")),
  #       p("The sample database we use for our showcase is created with the help of RSQLite. 
  #       We have named it PineApple sales database. 
  #       It is a SQLite database with 5 tables - order items (order_items), order details (orders), products information (prods_i), customer information (custs), and store information (stores). 
  #       Order information is generated randomly in SQLite, while store and product information is partially based on Apple’s public data to put our database into context.")
  #       
  # )  
  #   
  # })
